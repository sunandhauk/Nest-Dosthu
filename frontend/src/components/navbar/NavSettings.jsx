...
const SettingsModal = ({
  ...
  return createPortal(
    <div
      className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-start sm:items-center justify-center animate-fadeIn p-4 sm:p-0"
      onClick={onClose}
    >
      <div
        className="bg-white rounded-2xl shadow-2xl w-full sm:max-w-xl max-h-[90vh] sm:max-h-[85vh] overflow-y-auto transform transition-all duration-300 ease-out animate-slideUpAndFade relative"
    ...
    <>
      <div ref={settingsRef} className="relative">
        <button
          ...
          className="flex items-center justify-center p-2.5 text-neutral-600 hover:text-neutral-900 rounded-full hover:bg-neutral-100 active:bg-neutral-200 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 transform active:scale-95 transition-all duration-200"
